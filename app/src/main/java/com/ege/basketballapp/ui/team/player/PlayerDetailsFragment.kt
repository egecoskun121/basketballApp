package com.ege.basketballapp.ui.team.player
...
import com.ege.basketballapp.databinding.FragmentPlayerDetailsBinding
import com.ege.basketballapp.ui.team.TeamViewModel
...
class PlayerDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvProfileNameSingle.text=args.name
        binding.tvProfileName.text=args.name
        collapsingAvatarContainer = view.findViewById(R.id.stuff_container)
        appBarLayout = view.findViewById(R.id.app_bar_layout)
        toolbar = view.findViewById(R.id.anim_toolbar)
        toolbar.visibility = View.INVISIBLE
        ivAvatar = view.findViewById(R.id.imgb_avatar_wrap)
            ...
            AppBarLayout.OnOffsetChangedListener { appBarLayout, i ->
                if (isCalculated.not()) {
                    startAvatarAnimatePointY =
                        Math.abs((appBarLayout.height - EXPAND_AVATAR_SIZE - toolbar.height / 2) / appBarLayout.totalScrollRange)
